        ...
        <div class="listado-notas">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 empresa-texto">
            <h3 class="titulo">¡Tú eres el protagonista, nosotros tu equipo!.<br>
              <span>Vincula a tu organización y ayúdale a estar Pilas con el Ambiente promoviendo una cultura de recolección.</span>
            </h3>
    ...
    <div class="container interna-seccion2">
      <div class="listado-notas">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 empresa-titulos">
          <h3 class="titulo">¿Cómo solicitar la recolección de tus pilas usadas?</h3>
          <p class="parrafo1">Si tienes más de 30 kg de pilas y/o acumuladores usados, la recolección se realizará directamente en tus instalaciones. Si no alcanzas el mínimo de 30 kg, contamos con alternativas para ti.</p>
          <p class="parrafo1">Si utilizas un contenedor con una capacidad superior a 30 kg, te pedimos esperar a que esté lleno al menos en un 80% antes de programar la recolección. Esta medida nos permite optimizar las rutas y reducir nuestra huella de carbono.</p>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 nota-principal">
          ...
          <div class="caja_info3 col-xs-4 col-sm-4 col-md-4 col-lg-9">
            <a class="segundario-empresa" href="https://forms.office.com/r/CC6TvuRSRb">Haz tu solicitud de recolección.</a>
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 empresa-titulos">
  ...
  <div class="container-fluid color">
    <div class="container interna-seccion2">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 empresa-titulos2">
        <h3 class="titulo" style="color: #2E6946;">¡Cuando las pilas estén fuera de su lugar, tu recolección será vital!.</h3>
      </div>
    </div>
  </div>
</div>