<div class="tipos">
  ...
  <div class="miga">
          <a href="#">Inicio</a>
          <span> - </span>
          <a href="#" class="actual">Tipos de Pilas</a>
        </div>
    <div class="container interna tipos">
  ...
  <div class="container-fluid contenido-interna">
    <div class="container interna-seccion">
      ...
      <div class="galeria-tipos">
        ...
        <div class="slide-tipo">
          <div class="col-xs-12	col-sm-12	col-md-6 col-lg-6 imagen-bateria">
            <div class="contenedor-bateria">
                <img class="imagen-bateria" src="<?php echo $assets;?>images/tipos/pila_triple_a.png" alt="">
            </div>
          </div>
          <div class="col-xs-12	col-sm-12	col-md-5 col-lg-5 informacion-bateria">
        ...
        <div class="slide-tipo">
          <div class="col-xs-12	col-sm-12	col-md-6 col-lg-6 imagen-bateria">
            <div class="contenedor-bateria">
                <img class="imagen-bateria" src="<?php echo $assets;?>images/tipos/pila_tipo_c.png" alt="">
            </div>
          </div>
          <div class="col-xs-12	col-sm-12	col-md-5 col-lg-5 informacion-bateria">
        ...
        <div class="slide-tipo">
          <div class="col-xs-12	col-sm-12	col-md-6 col-lg-6 imagen-bateria">
            <div class="contenedor-bateria">
                <img class="imagen-bateria" src="<?php echo $assets;?>images/tipos/pila_cuadrada.png" alt="">
            </div>
          </div>
          <div class="col-xs-12	col-sm-12	col-md-5 col-lg-5 informacion-bateria">
        ...
        <div class="slide-tipo">
          <div class="col-xs-12	col-sm-12	col-md-6 col-lg-6 imagen-bateria">
            <div class="contenedor-bateria">
                <img class="imagen-bateria sin-paddin" src="<?php echo $assets;?>images/tipos/pila_tipo_d.png" alt="">
            </div>
          </div>
          <div class="col-xs-12	col-sm-12	col-md-5 col-lg-5 informacion-bateria">
        ...
        <div class="slide-tipo">
          <div class="col-xs-12	col-sm-12	col-md-6 col-lg-6 imagen-bateria">
            <div class="contenedor-bateria">
                <img class="imagen-bateria sin-paddin" src="<?php echo $assets;?>images/tipos/pila_cuadrada_6v.png" alt="">
            </div>
          </div>
          <div class="col-xs-12	col-sm-12	col-md-5 col-lg-5 informacion-bateria">
        ...
        <!--div class="slide-tipo">
          <div class="col-xs-12	col-sm-12	col-md-12  col-lg-6 imagen-bateria">
            <div class="contenedor-bateria">
                <img class="imagen-bateria" style="height: 70%; margin-top: 40px;" src="<?php echo $assets;?>images/tipos/pila_boton.png" alt="">
            </div>
          </div>
          <div class="col-xs-12	col-sm-12	col-md-12 col-lg-5 informacion-bateria">
            <h3 class="titulo-bateria color-7">Pila de Botón</h3>
            <p class="subtitulo-bateria">LR20	13A	R20, MN1300, UM1, HP2, Mono</p>
            <p class="descripcion-bateria">Una pila D mide  58 mm de largo incluyendo el boton del terminal y  33 milimetros (3.3 cms) de diámetro.</p>
            <a href="#ancla-contacto" class="boton-principal">Quiero saber más</a>
          </div>
        </div-->
