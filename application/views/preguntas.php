<div class="conoce cabezote">
  <div class="container-fluid preguntas">
   <div class="miga">
        <a href="#">Inicio</a>
        <span> - </span>
        <a href="#" class="actual">Preguntas Frecuentes</a>
   </div>
      ...
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-10">
           <div class="nuero-pre col-xs-3	col-sm-12 col-md-12 col-lg-1">
            <p>1</p>
         </div>   
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
            <h4>¿Qué es un acumulador?</h4>
            <p>Fuente de energía eléctrica obtenida por transformación directa de energía química y constituida por uno o varios elementos secundarios (recargables).</p>
         </div> 
       </div>    
      </div>
    </div>
 ...
 <div class="container-fluid blanco">
    <div class="container interna-seccion3">
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
            <h4>¿Qué es una pila?</h4>
            <p>Fuente de energía eléctrica obtenida por transformación directa de energía química y constituida por uno o varios elementos primarios (no recargables).</p>
         </div> 
       </div>    
      </div>
    </div>
  ...
  <div class="container-fluid gris-bajo">
    <div class="container interna-seccion3">
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-10">
         ...
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
            <h4>¿Qué es un punto de recolección?</h4>
            <p>Sitio o lugar acondicionado, destinado a ofrecer a los consumidores la posibilidad de devolver los residuos de pilas y/o acumuladores para su posterior traslado a los centros de acopio, almacenamiento, tratamiento, aprovechamiento, valorización y/o disposición final.</p>
         </div> 
       </div>    
      </div>
    </div>
    ...
    <div class="container interna-seccion3">
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
            <h4>¿El programa expide algún tipo de certificación para las organizaciones que entregan las pilas recolectadas?</h4>
            <p>El programa entrega actualmente un acta de almacenamiento donde se relaciona el peso recibido para posteriormente entregar un certificado de aprovechamiento a las organizaciones que disponen correctamente sus pilas usadas a través de nuestros canales. Este certificado es expedido entre 30 días.</p>
         </div> 
       </div>    
      </div>
    </div>
    ...
    <div class="container interna-seccion3">
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
            <h4>¿Qué pasa con las pilas que deposito en los puntos de recolección?</h4>
            <p>Son manipuladas únicamente por el operador logístico capacitado y autorizado para el manejo de este tipo de materiales. Ellos las recogen en el punto donde usted las depositó, las transportan y les dan un manejo seguro.</p>
         </div> 
       </div>    
      </div>
    </div>
    ...
    <div class="container interna-seccion3">
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         ...
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
            <h4>¿Las pilas ya no se pueden volver a botar en la basura?</h4>
            <p>Las pilas son de uso doméstico, sin embargo buscando darle un manejo ambientalmente adecuado, los invitamos a llevarlas a los puntos de recolección.</p>
         </div> 
       </div>    
      </div>
    </div>
 ...
 <div class="container-fluid amarillo">
    <div class="container interna-seccion3">
      <div class="listado-notas">
       <div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
         <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-10">
           <div class="nuero-pre mitad col-xs-3	col-sm-12 col-md-12 col-lg-1">
            <p>10</p>
         </div>   
         <div class="listado-preguntas col-xs-12	col-sm-12	col-md-12 col-lg-11">
