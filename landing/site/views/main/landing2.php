...
Activity name of this tag: CO_Pilas_Colombia_LP2
URL of the webpage where the tag is expected to be placed: http://www.pilascolombia.com/landing/2
...
document.write('<iframe src="http://4379943.fls.doubleclick.net/activityi;src=4379943;type=lp2fj367;cat=co_pi309;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
</script>
<noscript>
<iframe src="http://4379943.fls.doubleclick.net/activityi;src=4379943;type=lp2fj367;cat=co_pi309;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
</noscript>
	...
	<section class="wrapper">
		...
		<article class="right_content">
			...
			<div class="bloque">Es muy sencillo:<br/>
				...
				<div>&nbsp;</div>
				<div>&nbsp;</div>
                                <input type="hidden" name="interes" value="pilas2">
