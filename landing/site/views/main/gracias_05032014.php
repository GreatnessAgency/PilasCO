...
<head>
	...
	<title>Pilas Colombia</title>
        ...
        <meta property="og:url" content="https://pilascolombia.com/landing/" />
        <meta property="og:image" content="https://pilascolombia.com/landing/site/images/avatar.jpg" />
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<section class="wrapper">	
			<div class="wrapper logos" style=" display:table; ">
				<a class="fixie7" href="https://pilascolombia.com"><img style="margin-left:0;" src="<?php echo $template;?>images/pilas_con_el_ambiente.png" title="Pilas con el Ambiente"></a>
