    ...
    <div id="general">
        ...
        <div class="content2" style="background:#<?php echo $color; ?>">
            ...
            <div class="row">
                ...
                <?php } ?>
                <div class="col-sm-2">
                    <img class="thumbnail" src="<?= $template . 'images/filetypes/file.xlsx.png'; ?>" height="71" />
                    <iframe src="<?= $site_url ?>upload/upload_file/xls-xlsx/Document_16_a" width="280" marginheight="0" height="25" frameborder="0" scrolling="no" />
                    <input name="_compDocument"  onchange="changeLabel()" id="Document_16_a" class="required" placeholder="Excel" type="hidden" value="excel-d2903f7346d484483384ae368690911b.xlsx">
                </div>
                <div class="col-sm-6">
                    <div class="actions">
                        <a href="#!" class="btn" onclick="LoadContent( '#main', '<?= $site_url ?>', '<?= $controller ?>/index/<?= $module->id . '/0/' . $lang . '/'; ?>', function(){ Mitab('<?= $site_url ?>', 'gestor', 1); });">
