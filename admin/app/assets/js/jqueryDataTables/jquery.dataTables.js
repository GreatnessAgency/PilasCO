	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sEmptyTable": "No hay items disponibles",
				"sLoadingRecords": "Cargando...",
				"sInfo": "Mostrando desde _START_ hasta _END_ de _TOTAL_ resultados",
				"sInfoEmpty": "",
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						if ( sAttr == "H" )
						{
							sAttr = "fg-toolbar ui-toolbar head_blue ui-helper-clearfix";
						}
						else if ( sAttr == "F" )
						{
							sAttr = "fg-toolbar ui-toolbar ui-helper-clearfix";
						}
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" class="input" style="width:150px; height:20px;" />' : sSearchStr+' <input type="text" class="input" style="width:150px; height:20px;" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" '+sName+' class="input" style="width:60px; height:20px;">';
			var i, iLen;
