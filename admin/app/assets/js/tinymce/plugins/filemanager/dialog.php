...
if(isset($_GET['subfolder']) && !empty($_GET['subfolder'])) {
    ...
    $thumbs_path = '../../../../../../site/thumbs/' . $subfolder . '/';
		...
		foreach ($files as $nu=>$file) {
			...
			if(in_array($file_ext, $ext)){
			    if(in_array($file_ext, $ext_img)){
					...
					//add in thumbs folder if not exist 
					$thumb_path=dirname( __FILE__ ).DIRECTORY_SEPARATOR."../../../../../../site/thumbs".DIRECTORY_SEPARATOR.$subfolder.DIRECTORY_SEPARATOR.$subdir.$file;
				...
				//comentado por alejandro.. este if estaba bloqueando la visualizacion de documentos	
